...
public class HexViewer : Control
{
    ...
    public static readonly StyledProperty<FontFamily> FontFamilyProperty =
        AvaloniaProperty.Register<HexViewer, FontFamily>(nameof(FontFamily), FontFamily.Default);
    ...
    public override void Render(DrawingContext context)
    {
        ...
        var highlightedBackground = headerForeground is ISolidColorBrush accent
            ? (IBrush)new SolidColorBrush(accent.Color, 0.2)
            : Brushes.Transparent;
        var highlightedBorder = new Pen(headerForeground, 0.5);
        ...
        for (var i = 0; i < data.Count; i++)
        {
            ...
            var chLabel = new FormattedText(
                ...
                typeface,
                FONT_SIZE,
                isPrintable ? headerForeground : foreground);
...
public partial class BinaryFileViewer : ChromelessWindow
{
    ...
    private void OnContentSizeChanged(object sender, SizeChangedEventArgs e)
    {
        ...
        var viewport = Math.Max(0, grid.Bounds.Height - HexViewer.HEADER_HEIGHT);
