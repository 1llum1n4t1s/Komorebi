...
public static class StringConverters
{
    ...
    public static readonly FuncValueConverter<string, string> ToShortSHA =
        new FuncValueConverter<string, string>(v => v is null ? string.Empty : (v.Length > 10 ? v.Substring(0, 10) : v));
    ...
    public static readonly FuncValueConverter<string, bool> ContainsSpaces =
        new FuncValueConverter<string, bool>(v => v is not null && v.Contains(' '));

    public static readonly FuncValueConverter<string, bool> IsNotNullOrWhitespace =
        new FuncValueConverter<string, bool>(v => v is not null && v.Trim().Length > 0);
